...
// {B4D2C5A9-7B31-4A4B-9E64-3F2B8A1D6C50} MPC D3D11 video renderer
DEFINE_GUID(CLSID_D3D11VideoRenderer,
			0xB4D2C5A9, 0x7B31, 0x4A4B, 0x9E, 0x64, 0x3F, 0x2B, 0x8A, 0x1D, 0x6C, 0x50);

// {D4B2A7F1-5E93-46A2-B7D4-2C8F1A6E3B90} D3D11 allocator presenter
DEFINE_GUID(CLSID_D3D11AllocatorPresenter,
			0xD4B2A7F1, 0x5E93, 0x46A2, 0xB7, 0xD4, 0x2C, 0x8F, 0x1A, 0x6E, 0x3B, 0x90);
